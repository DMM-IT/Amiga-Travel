...
return new class extends Migration
{
    ...
    {
        DB::statement("ALTER TABLE website_settings MODIFY COLUMN `page` ENUM('header','footer','home','about','gallery','services','tour_package','contact_us','download') DEFAULT 'home'");
    }
};
