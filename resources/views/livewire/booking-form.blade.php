                    ...
                    @if ($step === 1)
                        <div class="relative">
                            ...
                            <div class="grid gap-4 grid-cols-2 lg:grid-cols-4 mt-4">
                                <div x-data="{ open: false }" class="relative block" data-error="mode" @click.outside="open = false">
                                ...
                                <div x-data="{ open: false }" class="relative block" @click.outside="open = false">
                            ...
                            <div x-data="{ open: false }" class="relative block" data-error="origin" @click.outside="open = false">
                            ...
                            <div x-data="{ open: false }" class="relative block" data-error="destination" @click.outside="open = false">
