                    ...
                    @if ($step === 1)
                        <div class="relative">
                            ...
                            <div class="grid gap-4 grid-cols-2 lg:grid-cols-4 mt-4">
                                <label class="relative block" data-error="mode" @click.outside="$wire.showModeDropdown = false">
                                ...
                                <label class="relative block" @click.outside="$wire.showOperatorDropdown = false">
                            ...
                            <label class="relative block" data-error="origin" @click.outside="$wire.showOriginDropdown = false">
                            ...
                            <label class="relative block" data-error="destination" @click.outside="$wire.showDestinationDropdown = false">
...
@elseif($mode === 'ferry')
    ...
    @if ($showDataPrivacyWarning)
        <div x-data="{ show: @entangle('showDataPrivacyWarning') }" x-show="show" class="fixed inset-0 z-[999] flex items-center justify-center p-4 bg-slate-900/70 backdrop-blur-sm overflow-y-auto">
            <div class="relative w-full max-w-xl max-h-[90vh] flex flex-col rounded-3xl bg-white p-6 sm:p-8 shadow-2xl ring-1 ring-slate-200 text-left overflow-hidden">
                ...
                <div class="mt-6 flex flex-col-reverse sm:flex-row items-center justify-end gap-3 shrink-0 pt-2">
                    ...
                    <button 
                        type="button" 
                        @click="show = false; $wire.acceptDataPrivacyWarning()"
