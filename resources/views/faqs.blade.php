    ...
    <div class="max-w-3xl mx-auto">
        ...
        <div class="text-center mb-12">
            ...
            <p class="mt-4 text-lg text-black font-semibold max-w-2xl mx-auto">
                {{ $pageContent['description'] ?? 'Find quick answers to common questions about booking, payments, cancellations, and our travel services.' }}
            </p>
        </div>

        <!-- FAQs Accordion -->
        <div class="bg-white/85 backdrop-blur-md rounded-2xl shadow-sm border border-slate-200 overflow-hidden" x-data="{ activeAccordion: null }">
            @php
        ...
        <div class="mt-12 text-center bg-white/85 backdrop-blur-md rounded-2xl p-8 border border-slate-200 shadow-sm flex flex-col items-center">
