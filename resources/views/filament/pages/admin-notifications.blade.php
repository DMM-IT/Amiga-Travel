    ...
    <div x-data="adminNotificationsPage()" x-init="init()" class="space-y-5">
        ...
        <div class="rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 shadow-sm overflow-hidden">
            ...
            <div>
                ...
                {{-- Tab bar --}}
                <div class="flex items-center gap-3 border-b border-gray-200 dark:border-gray-800 px-6 pt-5 pb-3 bg-white dark:bg-gray-900">
                    <button
                        type="button"
                        @click="switchTab('all')"
                        :class="activeTab === 'all'
                        ...
                        class="inline-flex items-center justify-center gap-1.5 rounded-full px-4 py-2 text-sm transition-all focus:outline-none focus:ring-2 focus:ring-primary-400/40 ring-offset-0"
                    >All</button>
                    <button
                        type="button"
                        ...
                        :class="activeTab === 'unread'
                            ? 'border border-primary-500 bg-primary-50 text-primary-700 dark:bg-primary-900/30 dark:text-primary-300 font-semibold shadow-sm'
                            : 'border border-transparent text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-200'"
                        class="inline-flex items-center justify-center gap-2 rounded-full px-4 py-2 text-sm transition-all focus:outline-none focus:ring-2 focus:ring-primary-400/40 ring-offset-0"
                    >
                        Unread
                        <span
                ...
                {{-- Toolbar --}}
                <div class="flex flex-col gap-3 px-6 py-4 sm:flex-row sm:items-center sm:justify-between border-b border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900">
                    {{-- Left: select + bulk actions --}}
                    <div class="flex flex-wrap items-center gap-3">
                        <label class="inline-flex items-center gap-3 cursor-pointer select-none text-sm font-medium text-gray-700 dark:text-gray-300">
                            <input
                                type="checkbox"
                                class="h-4 w-4 shrink-0 rounded border-gray-300 text-primary-500 focus:ring-primary-500 focus:ring-offset-0 dark:border-gray-600 dark:bg-gray-700 accent-primary-500"
                    ...
                    <div class="flex items-center gap-2">
                        <div class="relative w-full sm:w-64">
                            ...
                            <input
                                ...
                                class="w-full pr-4 py-2 rounded-xl border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-800 text-sm text-gray-900 dark:text-gray-100 placeholder-gray-400 dark:placeholder-gray-500 focus:border-primary-400 focus:outline-none focus:ring-2 focus:ring-primary-200 dark:focus:ring-primary-800 transition"
                            >
                        </div>
                    </div>
                </div>
