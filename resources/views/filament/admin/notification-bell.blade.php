<div x-data="adminNotificationBell({ initialNotifications: [], initialTotalCount: 0, initialUnreadCount: 0 })" x-init="fetchDropdown()" class="relative">
    <x-filament::dropdown placement="bottom-end" shift>
        ...
        <div class="w-96 max-w-[calc(100vw-2rem)] rounded-xl overflow-hidden bg-white dark:bg-gray-900 shadow-xl border border-gray-200 dark:border-gray-700">
            <div class="sticky top-0 z-10 border-b border-gray-100 bg-white px-4 py-3 dark:border-gray-800 dark:bg-gray-900">
                <div class="flex items-center justify-between gap-3">
                    <div>
                        <div class="text-xs font-semibold uppercase tracking-wide text-gray-600 dark:text-gray-400">Notifications</div>
                    ...
                    <div class="relative">
                        <button type="button" @click.prevent="actionMenuOpen = !actionMenuOpen" class="inline-flex items-center gap-2 rounded-lg border border-gray-200 bg-white px-3 py-2 text-xs font-semibold text-gray-700 shadow-sm hover:bg-gray-50 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-200 dark:hover:bg-gray-800">
                            Actions
            ...
            <div class="divide-y divide-gray-100 dark:divide-gray-800 max-h-[calc(100vh-12rem)] overflow-y-auto">
                ...
                <template x-for="notification in notifications" :key="notification.id">
                    <div class="flex items-start gap-3 px-4 py-3 hover:bg-gray-50 dark:hover:bg-gray-800">
                            ...
                            <button type="button" @click.prevent="openNotification(notification)" class="w-full text-left">
                                <div class="flex items-center justify-between gap-3">
                                    <div>
                                        ...
                                        <div class="mt-1 text-xs text-gray-500 dark:text-gray-400" x-text="notification.message"></div>
                                    </div>
                                    <div class="shrink-0 text-[11px] text-gray-400" x-text="notification.created_at"></div>
                                </div>
                            </button>
                        </div>
                        <div class="relative">
